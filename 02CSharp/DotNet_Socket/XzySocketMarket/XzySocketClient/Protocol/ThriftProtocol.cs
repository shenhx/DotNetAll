...
namespace XzySocketClient.Protocol
{
    ...
    public sealed class ThriftProtocol : IProtocol<Messaging.ThriftMessage>
    {
        ...
        public Messaging.ThriftMessage Parse(IConnection connection,
            ...
            out int readlength)
        {
            ...
            var cmdLen = XzySocketBase.Utils.NetworkBitConverter.ToInt32(buffer.Array, buffer.Offset + 8);
            if (messageLength < cmdLen + 13) throw new BadProtocolException("bad thrift protocol");

            int seqID = XzySocketBase.Utils.NetworkBitConverter.ToInt32(buffer.Array, buffer.Offset + 12 + cmdLen);
