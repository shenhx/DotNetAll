...
namespace XzySocketServer
{
    ...
    public class SocketServer<TMessage> : BaseHost where TMessage : class, Messaging.IMessage
    {
        ...
        private void OnAccepted(ISocketListener listener, IConnection connection)
        {
            ...
            XzySocketBase.Log.Trace.Info("too many connections.");
        ...
        protected override void OnSendCallback(IConnection connection,
            Packet packet, bool isSuccess)
        {
