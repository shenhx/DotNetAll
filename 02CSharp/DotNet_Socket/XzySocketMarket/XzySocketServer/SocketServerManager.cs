...
namespace XzySocketServer
{
    ...
    public class SocketServerManager
    {
        ...
        /// key:server name.
        /// </summary>
        static private readonly Dictionary<string, IHost> _dicHosts =
        ...
        static public void Init(Config.SocketServerConfig config)
        {
            ...
            {
                if (_dicHosts.ContainsKey(serverConfig.Name))
                    continue;
                //inti protocol
                ...
                _dicHosts.Add(serverConfig.Name, Activator.CreateInstance(
                    ...
                    objProtocol.GetType().GetInterface(typeof(Protocol.IProtocol<>).Name).GetGenericArguments()),
                        ...
                        serverConfig.MaxConnections) as IHost);
            }
        }
        /// <summary>
        /// get protocol.
        ...
        /// <returns></returns>
        static public bool TryGetHost(string name, out IHost host)
        {
